...
from aggressive_stopper_sparse_ab_destack_endgame_escape.util import *
import copy
...
def minimax(layout, depth, alpha, beta, maximizing_player, colour, our_colour, escape):
    ...
    if maximizing_player:
        ...
        for t, a, l in action_layout_list:
            eval, _, escape = minimax(l, depth - 1, alpha, beta, False, colour, our_colour, escape)
        ...
        action_layout_list = generate_all_layouts(layout, colour)
        for t, a, l in action_layout_list:
            eval, _, escape = minimax(l, depth - 1, alpha, beta, True, colour, our_colour, escape)
    ...
    for token in layout[colour]:
        ...
        for destination in destinations:
            for numToken in range(token[0]):
                ...
                action_layout_list.append((token, action, next_layout))
